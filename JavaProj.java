//Desenvolvido por: Lidiane Mel
/*Faça um programa de um Jogo de Números em que o usuario tem que acertar
o número que o programa escolher*/
//package jogo_dos_numeros;
...
public class Jogo_dos_Numeros {
    ...
    public static void main(String[] args) {
     ...
     int R, N, cont, Rd=1; 
     String nome, resp="5";
     do{ R= rand.nextInt(10); //(linha 18 e 19)Gerar numero automatico de 0 a 10
        cont=1;
       System.out.print("Digite o Nome do Jogador: "); //(linha 20 e 21)Entrada do nome do Jogador
       nome = sc.next();
     
       do{    //(linha 23 a 26) Primeira tentativa do jogador
         ...
         if(R==N)  //(linha 28 a 31) Comparação do Numero rondomico com o numero do usuário
         ...
         if(cont<Rd) //Recorde dos Jogadores(usuários do jogo)
            Rd = cont; //Recorde é o número de tentativas (Quanto menor o número melhor foi)
           System.out.println("PONTOS: "+Rd); //Exibição
        cont++; // Fim da Partida
        }while(R!=N);  //(linha 37 a 41) A liberdade do usuário por optar por outra partida do Jogo
